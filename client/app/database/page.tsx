...
export default function DatabaseStudioPage() {
  ...
  return (
    <div className="page-wrap" style={{ paddingBottom: 110 }}>
      {/* 1. Global Navigation & Overview Header with Telemetry Summary */}
      <DatabaseHeader
      ...
      {/* Slide-Over Entry Creation Drawer */}
      <EntryCreationDrawer
      ...
      {/* Database Operations & Ingestion Modal */}
      ...
      {/* Persistent Staged Changes Bottom Dock */}
      <StagedChangesBar
